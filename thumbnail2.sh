...
drawtext=text='$TEXT2':fontcolor=yellow:fontsize=48:box=1:boxcolor=black@0.5:boxborderw=5:x=(w-text_w)-200:y=(h-text_h)-20, \
drawtext=text='$TEXT3':fontcolor=yellow:fontsize=64:box=1:boxcolor=black@0.9:boxborderw=5:x=(w-text_w)/2:y=(h-text_h)/2-160" -y "$OUTPUT_THUMBNAIL"
